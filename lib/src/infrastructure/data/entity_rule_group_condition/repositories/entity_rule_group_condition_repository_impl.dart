...
class EntityRuleGroupConditionRepositoryImpl implements EntityRuleGroupConditionRepository {
  ...
  Future<EntityRuleGroupCondition> getById(String id) async {
    try {
      ...
      throw DomainException(
        message: 'Não foi possível encontrar o grupo de condições da regra da entidade',
        trace: s.toString(),
      );
    }
  }
  ...
  @override
  Future<List<EntityRuleGroupCondition>> getByEntityRule(String entityRuleId) async {
    try {
      ...
      throw DomainException(
        message: 'Não foi possível encontrar os grupo de condições da regra da aplicação',
        trace: s.toString(),
      );
    }
  }
  ...
  @override
  Future<EntityRuleGroupCondition> save(EntityRuleGroupCondition entityRuleGroupCondition) async {
    try {
      ...
      throw DomainException(
        message: 'Não foi possível salvar o grupo de condições da regra da entidade',
        trace: s.toString(),
      );
    }
  }
  ...
  @override
  Future<EntityRuleGroupCondition> update(EntityRuleGroupCondition entityRuleGroupCondition) async {
    try {
      final doc = _firestore.collection(collection).doc(entityRuleGroupCondition.id);
      final entityRuleGroupConditionModel = EntityRuleGroupConditionModel.fromEntity(entityRuleGroupCondition);
      await doc.update(entityRuleGroupConditionModel.toJson());
  ...
  Future<void> delete(String id) async {
    try {
      ...
      throw DomainException(
        message: 'Não foi possível remover o grupo de condições da regra da entidade',
        trace: s.toString(),
      );
    }
  }
