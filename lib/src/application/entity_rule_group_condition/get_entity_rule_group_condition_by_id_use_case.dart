...
class GetEntityRuleGroupConditionByIdUseCase {
  late final EntityRuleGroupConditionRepository _entityRuleGroupConditionRepository;

  GetEntityRuleGroupConditionByIdUseCase({
    required EntityRuleGroupConditionRepository entityRuleGroupConditionRepository,
  }) {
  ...
  Future<Either<DomainException, EntityRuleGroupCondition>> execute(
    ...
    try {
      final result = await _entityRuleGroupConditionRepository.getById(id);
      return Right(result);
      ...
      return Left(
        DomainException.of(
          message: e.toString(),
          trace: s.toString(),
          context: 'GetEntityRuleGroupConditionByIdUseCase',
        ),
      );
    }
  }
