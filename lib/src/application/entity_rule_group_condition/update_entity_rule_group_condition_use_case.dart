...
class UpdateEntityRuleGroupConditionUseCase {
  late final EntityRuleGroupConditionRepository
      _entityRuleGroupConditionRepository;

  UpdateEntityRuleGroupConditionUseCase({
  ...
  Future<Either<DomainException, EntityRuleGroupCondition>> execute(
    ...
    try {
      final result = await _entityRuleGroupConditionRepository.update(
      ...
      return Left(
        DomainException.of(
          message: e.toString(),
          trace: s.toString(),
          context: 'UpdateEntityRuleGroupConditionUseCase',
        ),
      );
    }
  }
