...
class SaveValueObjectRuleUseCase {
  ...
  Future<Either<DomainException, ValueObjectRule>> execute(
    ...
    try {
      final result = await _valueObjectRuleRepository.save(valueObjectRule);
      return Right(result);
      ...
      return Left(
        DomainException.of(
          message: e.toString(),
          trace: s.toString(),
          context: 'SaveValueObjectRuleUseCase',
        ),
      );
    }
  }
