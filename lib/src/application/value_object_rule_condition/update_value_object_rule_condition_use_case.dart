...
class UpdateValueObjectRuleConditionUseCase {
  late final ValueObjectRuleConditionRepository
      _valueObjectRuleConditionRepository;

  UpdateValueObjectRuleConditionUseCase({
  ...
  Future<Either<DomainException, ValueObjectRuleCondition>> execute(
    ...
    try {
      final result = await _valueObjectRuleConditionRepository.update(
      ...
      return Left(
        DomainException.of(
          message: e.toString(),
          trace: s.toString(),
          context: 'UpdateValueObjectRuleConditionUseCase',
        ),
      );
    }
  }
